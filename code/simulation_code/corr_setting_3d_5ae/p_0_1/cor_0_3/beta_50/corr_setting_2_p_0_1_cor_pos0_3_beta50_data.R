...
beta_1[1,1] <- 50 #drug 1 associated with AE 1
# model 2: logit(d1) = beta*a1 + beta*a2
beta_2 <- matrix(0,num_drugs,num_ae)
beta_2[1,1:2] <- 50 #drug 1 associated with AE 1 and AE 2
...
data_path_1 <- "/Users/reetikasarkar/Dropbox/My Mac (Reetika’s MacBook Pro)/Documents/dissertation_research/codes/data/correlated_setting_3d_5ae/p_0_1/cor_0_3/beta_50/model_1"
data_path_2 <- "/Users/reetikasarkar/Dropbox/My Mac (Reetika’s MacBook Pro)/Documents/dissertation_research/codes/data/correlated_setting_3d_5ae/p_0_1/cor_0_3/beta_50/model_2"
