...
beta_1[1,1] <- 10 #drug 1 associated with AE 1
# model 2: logit(d1) = beta*a1 + beta*a2
beta_2 <- matrix(0,num_drugs,num_ae)
beta_2[1,1:2] <- 10 #drug 1 associated with AE 1 and AE 2
...
data_path_1 <- "/Users/reetikasarkar/Dropbox/My Mac (Reetika’s MacBook Pro)/Documents/dissertation_research/codes/data/correlated_setting_3d_5ae/p_0_3/cor_0_5/beta_10/model_1"
data_path_2 <- "/Users/reetikasarkar/Dropbox/My Mac (Reetika’s MacBook Pro)/Documents/dissertation_research/codes/data/correlated_setting_3d_5ae/p_0_3/cor_0_5/beta_10/model_2"
