---
title: "Plots for accuracy measures for important pairs in 3 drugs and 5 AEs, p=0.3"
author: "Reetika Sarkar"
output: html_document
---

```{r load_libraries}
## dependent SETTING 1: p=0.1, 0.3 and 0.5
...
combined_sens_plot_pair1 <- grid.arrange(combined_plot, legend, nrow=2, heights=c(8.5,2), top = "Sensitivity plots for drug1-AE1 pair, 3 drugs and 5 AEs (p = 0.3) setting")
sens_plot_file_pair1 <- "/Users/reetikasarkar/Dropbox/My Mac (Reetika’s MacBook Pro)/Documents/dissertation_research/codes/plots/setting_3d_5ae/p_0_3/sens_pair1.png"
...
#final combined plot with common legend
combined_sens_plot_pair2 <- grid.arrange(combined_plot, legend, nrow=2, heights=c(8.5,2), top = "Sensitivity plots for drug1-AE2 pair, 3 drugs and 5 AEs (p = 0.3) setting")
sens_plot_file_pair2 <- "/Users/reetikasarkar/Dropbox/My Mac (Reetika’s MacBook Pro)/Documents/dissertation_research/codes/plots/setting_3d_5ae/p_0_3/sens_pair2.png"
#print(combined_sens_plot)
