---
title: "corr_setting_3_p_0.1_cor_0.3_beta100_model2"
...
data_loc <- "/Users/reetikasarkar/Dropbox/My Mac (Reetika’s MacBook Pro)/Documents/dissertation_research/apriori_project/codes/data/correlated_setting_5d_10ae/p_0_1/cor_0_3/beta_100/model_2/sim_"

results_loc <- "/Users/reetikasarkar/Dropbox/My Mac (Reetika’s MacBook Pro)/Documents/dissertation_research/apriori_project/codes/results/correlated_setting_5d_10ae/p_0_1/cor_0_3/beta_100/model_2"
  
num_sim = 1000 # 100
num_reports = 500 # 100
min_support = 0.05 * num_reports
...
imp_2_set <- as.data.frame(rbind(c("d1", "a1"), c("d1", "a2"), c("d1", "a3"), c("d1", "a4"), c("d1", "a5"), c("d2", "a1"), c("d2", "a2"), c("d2", "a3"), c("d3", "a1"))) # 9 important pairs
names(imp_2_set) <- c("item1", "item2")
sens_for_ind_pairs_1 <- array(0,dim=c(4, 4))
sens_for_ind_pairs_2 <- array(0,dim=c(4, 4))
sens_for_ind_pairs_3 <- array(0,dim=c(4, 4))
sens_for_ind_pairs_4 <- array(0,dim=c(4, 4))
sens_for_ind_pairs_5 <- array(0,dim=c(4, 4))
sens_for_ind_pairs_6 <- array(0,dim=c(4, 4))
sens_for_ind_pairs_7 <- array(0,dim=c(4, 4))
sens_for_ind_pairs_8 <- array(0,dim=c(4, 4))
sens_for_ind_pairs_9 <- array(0,dim=c(4, 4))
```
...
conf_counter_ind_pair_3 <- array(0, dim=c(num_sim, num_conf_val))
prr_counter_ind_pair_3 <- array(0, dim=c(num_sim, num_prr_val))
rr_counter_ind_pair_3 <- array(0, dim=c(num_sim, num_rr_val))
ror_counter_ind_pair_3 <- array(0, dim=c(num_sim, num_ror_val))

conf_counter_ind_pair_4 <- array(0, dim=c(num_sim, num_conf_val))
prr_counter_ind_pair_4 <- array(0, dim=c(num_sim, num_prr_val))
rr_counter_ind_pair_4 <- array(0, dim=c(num_sim, num_rr_val))
ror_counter_ind_pair_4 <- array(0, dim=c(num_sim, num_ror_val))

conf_counter_ind_pair_5 <- array(0, dim=c(num_sim, num_conf_val))
prr_counter_ind_pair_5 <- array(0, dim=c(num_sim, num_prr_val))
rr_counter_ind_pair_5 <- array(0, dim=c(num_sim, num_rr_val))
ror_counter_ind_pair_5 <- array(0, dim=c(num_sim, num_ror_val))

conf_counter_ind_pair_6 <- array(0, dim=c(num_sim, num_conf_val))
prr_counter_ind_pair_6 <- array(0, dim=c(num_sim, num_prr_val))
rr_counter_ind_pair_6 <- array(0, dim=c(num_sim, num_rr_val))
ror_counter_ind_pair_6 <- array(0, dim=c(num_sim, num_ror_val))

conf_counter_ind_pair_7 <- array(0, dim=c(num_sim, num_conf_val))
prr_counter_ind_pair_7 <- array(0, dim=c(num_sim, num_prr_val))
rr_counter_ind_pair_7 <- array(0, dim=c(num_sim, num_rr_val))
ror_counter_ind_pair_7 <- array(0, dim=c(num_sim, num_ror_val))

conf_counter_ind_pair_8 <- array(0, dim=c(num_sim, num_conf_val))
prr_counter_ind_pair_8 <- array(0, dim=c(num_sim, num_prr_val))
rr_counter_ind_pair_8 <- array(0, dim=c(num_sim, num_rr_val))
ror_counter_ind_pair_8 <- array(0, dim=c(num_sim, num_ror_val))

conf_counter_ind_pair_9 <- array(0, dim=c(num_sim, num_conf_val))
prr_counter_ind_pair_9 <- array(0, dim=c(num_sim, num_prr_val))
rr_counter_ind_pair_9 <- array(0, dim=c(num_sim, num_rr_val))
ror_counter_ind_pair_9 <- array(0, dim=c(num_sim, num_ror_val))
```
  ...
  for (conf in 1:num_conf_val) {
    if (nrow(l2) == 0){
      ...
      if (nrow(freq2_conf) != 0){
        ...
        if (setequal(intersect(imp_2_set[3,],freq2_conf[,1:2]), imp_2_set[3,])) {
          conf_counter_ind_pair_3[sim,conf] <- 1
        }
        if (setequal(intersect(imp_2_set[4,],freq2_conf[,1:2]), imp_2_set[4,])) {
          conf_counter_ind_pair_4[sim,conf] <- 1
        }
        if (setequal(intersect(imp_2_set[5,],freq2_conf[,1:2]), imp_2_set[5,])) {
          conf_counter_ind_pair_5[sim,conf] <- 1
        }
        if (setequal(intersect(imp_2_set[6,],freq2_conf[,1:2]), imp_2_set[6,])) {
          conf_counter_ind_pair_6[sim,conf] <- 1
        }
        if (setequal(intersect(imp_2_set[7,],freq2_conf[,1:2]), imp_2_set[7,])) {
          conf_counter_ind_pair_7[sim,conf] <- 1
        }
        if (setequal(intersect(imp_2_set[8,],freq2_conf[,1:2]), imp_2_set[8,])) {
          conf_counter_ind_pair_8[sim,conf] <- 1
        }
        if (setequal(intersect(imp_2_set[9,],freq2_conf[,1:2]), imp_2_set[9,])) {
          conf_counter_ind_pair_9[sim,conf] <- 1
        }
  ...
  for (conf in 1:num_conf_val) {
    if (nrow(l2) == 0){
      ...
      if(nrow(freq2_prr) != 0){
        ...
        if (setequal(intersect(imp_2_set[3,],freq2_prr[,1:2]), imp_2_set[3,])) {
          prr_counter_ind_pair_3[sim,conf] <- 1
        }
        if (setequal(intersect(imp_2_set[4,],freq2_prr[,1:2]), imp_2_set[4,])) {
          prr_counter_ind_pair_4[sim,conf] <- 1
        }
        if (setequal(intersect(imp_2_set[5,],freq2_prr[,1:2]), imp_2_set[5,])) {
          prr_counter_ind_pair_5[sim,conf] <- 1
        }
        if (setequal(intersect(imp_2_set[6,],freq2_prr[,1:2]), imp_2_set[6,])) {
          prr_counter_ind_pair_6[sim,conf] <- 1
        }
        if (setequal(intersect(imp_2_set[7,],freq2_prr[,1:2]), imp_2_set[7,])) {
          prr_counter_ind_pair_7[sim,conf] <- 1
        }
        if (setequal(intersect(imp_2_set[8,],freq2_prr[,1:2]), imp_2_set[8,])) {
          prr_counter_ind_pair_8[sim,conf] <- 1
        }
        if (setequal(intersect(imp_2_set[9,],freq2_prr[,1:2]), imp_2_set[9,])) {
          prr_counter_ind_pair_9[sim,conf] <- 1
        }
      ...
      if(nrow(freq2_rr) != 0){
        ...
        if (setequal(intersect(imp_2_set[3,],freq2_rr[,1:2]), imp_2_set[3,])) {
          rr_counter_ind_pair_3[sim, conf] <- 1
        }
        if (setequal(intersect(imp_2_set[4,],freq2_rr[,1:2]), imp_2_set[4,])) {
          rr_counter_ind_pair_4[sim, conf] <- 1
        }
        if (setequal(intersect(imp_2_set[5,],freq2_rr[,1:2]), imp_2_set[5,])) {
          rr_counter_ind_pair_5[sim, conf] <- 1
        }
        if (setequal(intersect(imp_2_set[6,],freq2_rr[,1:2]), imp_2_set[6,])) {
          rr_counter_ind_pair_6[sim, conf] <- 1
        }
        if (setequal(intersect(imp_2_set[7,],freq2_rr[,1:2]), imp_2_set[7,])) {
          rr_counter_ind_pair_7[sim, conf] <- 1
        }
        if (setequal(intersect(imp_2_set[8,],freq2_rr[,1:2]), imp_2_set[8,])) {
          rr_counter_ind_pair_8[sim, conf] <- 1
        }
        if (setequal(intersect(imp_2_set[9,],freq2_rr[,1:2]), imp_2_set[9,])) {
          rr_counter_ind_pair_9[sim, conf] <- 1
        }
      ...
      acc_measures_rr[sim,1:num_measures,conf] <- c(sn_rr, sp_rr, ppv_rr, npv_rr, fscore_rr)
      ...
      if(nrow(freq2_ror) != 0){
        ...
        if (setequal(intersect(imp_2_set[3,],freq2_ror[,1:2]), imp_2_set[3,])) {
          ror_counter_ind_pair_3[sim,conf] <- 1
        }
        if (setequal(intersect(imp_2_set[4,],freq2_ror[,1:2]), imp_2_set[4,])) {
          ror_counter_ind_pair_4[sim,conf] <- 1
        }
        if (setequal(intersect(imp_2_set[5,],freq2_ror[,1:2]), imp_2_set[5,])) {
          ror_counter_ind_pair_5[sim,conf] <- 1
        }
        if (setequal(intersect(imp_2_set[6,],freq2_ror[,1:2]), imp_2_set[6,])) {
          ror_counter_ind_pair_6[sim,conf] <- 1
        }
        if (setequal(intersect(imp_2_set[7,],freq2_ror[,1:2]), imp_2_set[7,])) {
          ror_counter_ind_pair_7[sim,conf] <- 1
        }
        if (setequal(intersect(imp_2_set[8,],freq2_ror[,1:2]), imp_2_set[8,])) {
          ror_counter_ind_pair_8[sim,conf] <- 1
        }
        if (setequal(intersect(imp_2_set[9,],freq2_ror[,1:2]), imp_2_set[9,])) {
          ror_counter_ind_pair_9[sim,conf] <- 1
        }
...
sens_for_ind_pairs_3[1,] <- colSums(conf_counter_ind_pair_3)/num_sim
sens_for_ind_pairs_3[2,] <- colSums(prr_counter_ind_pair_3)/num_sim
sens_for_ind_pairs_3[3,] <- colSums(rr_counter_ind_pair_3)/num_sim
sens_for_ind_pairs_3[4,] <- colSums(ror_counter_ind_pair_3)/num_sim
row.names(sens_for_ind_pairs_3) <- c("conf_thresh", "prr_thresh", "rr_thresh", "ror_thresh")
write.table(x = sens_for_ind_pairs_3, file = paste0(results_loc,"/sens_ind_pair_d1a3.csv"), row.names = T)
sens_for_ind_pairs_3

sens_for_ind_pairs_4[1,] <- colSums(conf_counter_ind_pair_4)/num_sim
sens_for_ind_pairs_4[2,] <- colSums(prr_counter_ind_pair_4)/num_sim
sens_for_ind_pairs_4[3,] <- colSums(rr_counter_ind_pair_4)/num_sim
sens_for_ind_pairs_4[4,] <- colSums(ror_counter_ind_pair_4)/num_sim
row.names(sens_for_ind_pairs_4) <- c("conf_thresh", "prr_thresh", "rr_thresh", "ror_thresh")
write.table(x = sens_for_ind_pairs_4, file = paste0(results_loc,"/sens_ind_pair_d1a4.csv"), row.names = T)
sens_for_ind_pairs_4

sens_for_ind_pairs_5[1,] <- colSums(conf_counter_ind_pair_5)/num_sim
sens_for_ind_pairs_5[2,] <- colSums(prr_counter_ind_pair_5)/num_sim
sens_for_ind_pairs_5[3,] <- colSums(rr_counter_ind_pair_5)/num_sim
sens_for_ind_pairs_5[4,] <- colSums(ror_counter_ind_pair_5)/num_sim
row.names(sens_for_ind_pairs_5) <- c("conf_thresh", "prr_thresh", "rr_thresh", "ror_thresh")
write.table(x = sens_for_ind_pairs_5, file = paste0(results_loc,"/sens_ind_pair_d1a5.csv"), row.names = T)
sens_for_ind_pairs_5

sens_for_ind_pairs_6[1,] <- colSums(conf_counter_ind_pair_6)/num_sim
sens_for_ind_pairs_6[2,] <- colSums(prr_counter_ind_pair_6)/num_sim
sens_for_ind_pairs_6[3,] <- colSums(rr_counter_ind_pair_6)/num_sim
sens_for_ind_pairs_6[4,] <- colSums(ror_counter_ind_pair_6)/num_sim
row.names(sens_for_ind_pairs_6) <- c("conf_thresh", "prr_thresh", "rr_thresh", "ror_thresh")
write.table(x = sens_for_ind_pairs_6, file = paste0(results_loc,"/sens_ind_pair_d2a1.csv"), row.names = T)
sens_for_ind_pairs_6

sens_for_ind_pairs_7[1,] <- colSums(conf_counter_ind_pair_7)/num_sim
sens_for_ind_pairs_7[2,] <- colSums(prr_counter_ind_pair_7)/num_sim
sens_for_ind_pairs_7[3,] <- colSums(rr_counter_ind_pair_7)/num_sim
sens_for_ind_pairs_7[4,] <- colSums(ror_counter_ind_pair_7)/num_sim
row.names(sens_for_ind_pairs_7) <- c("conf_thresh", "prr_thresh", "rr_thresh", "ror_thresh")
write.table(x = sens_for_ind_pairs_7, file = paste0(results_loc,"/sens_ind_pair_d2a2.csv"), row.names = T)
sens_for_ind_pairs_7

sens_for_ind_pairs_8[1,] <- colSums(conf_counter_ind_pair_8)/num_sim
sens_for_ind_pairs_8[2,] <- colSums(prr_counter_ind_pair_8)/num_sim
sens_for_ind_pairs_8[3,] <- colSums(rr_counter_ind_pair_8)/num_sim
sens_for_ind_pairs_8[4,] <- colSums(ror_counter_ind_pair_8)/num_sim
row.names(sens_for_ind_pairs_8) <- c("conf_thresh", "prr_thresh", "rr_thresh", "ror_thresh")
write.table(x = sens_for_ind_pairs_8, file = paste0(results_loc,"/sens_ind_pair_d2a3.csv"), row.names = T)
sens_for_ind_pairs_8

sens_for_ind_pairs_9[1,] <- colSums(conf_counter_ind_pair_9)/num_sim
sens_for_ind_pairs_9[2,] <- colSums(prr_counter_ind_pair_9)/num_sim
sens_for_ind_pairs_9[3,] <- colSums(rr_counter_ind_pair_9)/num_sim
sens_for_ind_pairs_9[4,] <- colSums(ror_counter_ind_pair_9)/num_sim
row.names(sens_for_ind_pairs_9) <- c("conf_thresh", "prr_thresh", "rr_thresh", "ror_thresh")
write.table(x = sens_for_ind_pairs_9, file = paste0(results_loc,"/sens_ind_pair_d3a1.csv"), row.names = T)
sens_for_ind_pairs_9
```