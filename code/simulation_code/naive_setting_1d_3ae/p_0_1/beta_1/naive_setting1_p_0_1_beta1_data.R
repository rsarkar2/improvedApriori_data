...
##### NAIVE setting: 
#all AEs are 0s and 1s and independent of each other (bernoulli with prob=0.1)
...
beta[num_drugs,1] <- 1 #drug 1 associated with AE 1
...
colnames(y) <- paste0("d",1:num_drugs)
...
data_path <- "/Users/reetikasarkar/Dropbox/My Mac (Reetika’s MacBook Pro)/Documents/dissertation_research/apriori_project/codes/data/naive_setting_1d_3ae/p_0_1/beta_1"
