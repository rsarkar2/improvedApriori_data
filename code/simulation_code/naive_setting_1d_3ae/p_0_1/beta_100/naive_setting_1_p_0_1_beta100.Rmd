---
title: "naive_setting_1_p_0.1_beta100"
...
data_loc <- "/Users/reetikasarkar/Dropbox/My Mac (Reetika’s MacBook Pro)/Documents/dissertation_research/apriori_project/codes/data/naive_setting_1d_3ae/p_0_1/beta_100/sim_"

results_loc <- "/Users/reetikasarkar/Dropbox/My Mac (Reetika’s MacBook Pro)/Documents/dissertation_research/apriori_project/codes/results/naive_setting_1d_3ae/p_0_1/beta_100"
...
dimnames(acc_measures_conf)[[2]] = dimnames(acc_measures_prr)[[2]] = dimnames(acc_measures_rr)[[2]] = dimnames(acc_measures_ror)[[2]]= c("Sensitivity","Specificity","PPV","NPV","Total Accuracy")
...
for (sim in 1:num_sim) {
  ...
  for (conf in 1:num_conf_val) {
    ...
    # 2 itemsets
      ...
      tot_not_imp <- choose(4, 2) - tot_imp # fp + tn : total non-associated pairs
