...
num_sim <- 1000 #50
p_ae <- 0.3 #prob of drug being given: 0.1, 0.3, 0.5
...
beta[num_drugs,1] <- 100 #drug 1 associated with AE 1
...
data_path <- "/Users/reetikasarkar/Dropbox/My Mac (Reetika’s MacBook Pro)/Documents/dissertation_research/codes/data/naive_setting_1d_3ae/p_0_3/beta_100"
