...
beta[num_drugs,1] <- 50 #drug 1 associated with AE 1
...
data_path <- "/Users/reetikasarkar/Dropbox/My Mac (Reetika’s MacBook Pro)/Documents/dissertation_research/codes/data/naive_setting_1d_3ae/p_0_3/beta_50"
