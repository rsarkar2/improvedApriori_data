...
# NAIVE SETTING 1
num_drugs <- 3 #5, 15, 20, 50
num_ae <- 5 #10, 20, 50, 100
...
beta[1,1:2] <- 1 #drug 1 associated with AE1 and AE2
...
data_path <- "/Users/reetikasarkar/Dropbox/My Mac (Reetika’s MacBook Pro)/Documents/dissertation_research/apriori_project/codes/data/naive_setting_3d_5ae/p_0_3/beta_1"
