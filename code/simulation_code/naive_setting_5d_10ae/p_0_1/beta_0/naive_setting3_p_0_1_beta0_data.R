...
data_path <- "/Users/reetikasarkar/Dropbox/My Mac (Reetika’s MacBook Pro)/Documents/dissertation_research/codes/data/naive_setting_5d_10ae/p_0_1/beta_0"
...
for (sim in 1:num_sim) {
  ...
  for (row in 1:num_reports) {
    ...
    for (d in 1:num_drugs) {
      y[row,d] <- rbinom(1,1,p)
    }
  }
