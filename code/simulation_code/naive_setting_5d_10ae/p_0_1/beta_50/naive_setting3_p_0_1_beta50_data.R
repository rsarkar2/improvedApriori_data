...
beta[1,1:5] <- 50 #naive value (drug1 associated with first 5 AEs)
beta[2,1:3] <- 50 #naive value (drug2 associated with first 3 AEs)
beta[3,1] <- 50 #naive value (drug3 associated with 1 AE)
...
data_path <- "/Users/reetikasarkar/Dropbox/My Mac (Reetika’s MacBook Pro)/Documents/dissertation_research/codes/data/naive_setting_5d_10ae/p_0_1/beta_50"
