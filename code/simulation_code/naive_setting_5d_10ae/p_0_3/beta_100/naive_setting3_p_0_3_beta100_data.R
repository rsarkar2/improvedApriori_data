...
num_sim <- 1000 #50
p <- 0.3 #prob of drug being given: 0.1, 0.3, 0.5
...
data_path <- "/Users/reetikasarkar/Documents/dissertation_research/apriori_project/codes/data/naive_setting_5d_10ae/p_0_3/beta_100"
...
for (sim in 1:num_sim) {
  ...
  for (row in 1:num_reports) {
    for (ae in 1:num_ae) {
      x[row,ae] <- rbinom(1,1,0.3) #all AEs are independent
    }
    p1 <- x[row,] %*% beta[1,] 
