...
results_loc_beta1 <- "/Users/reetikasarkar/Dropbox/My Mac (Reetika’s MacBook Pro)/Documents/dissertation_research/codes/results/naive_setting_5d_10ae/p_0_5/beta_1"
results_loc_beta10 <- "/Users/reetikasarkar/Dropbox/My Mac (Reetika’s MacBook Pro)/Documents/dissertation_research/codes/results/naive_setting_5d_10ae/p_0_5/beta_10"
results_loc_beta50 <- "/Users/reetikasarkar/Dropbox/My Mac (Reetika’s MacBook Pro)/Documents/dissertation_research/codes/results/naive_setting_5d_10ae/p_0_5/beta_50"
results_loc_beta100 <- "/Users/reetikasarkar/Dropbox/My Mac (Reetika’s MacBook Pro)/Documents/dissertation_research/codes/results/naive_setting_5d_10ae/p_0_5/beta_100"
...
grid.arrange(combined_plot, legend, nrow=2, heights=c(10,1), top = "Sensitivity plots for p = 0.5 setting")
```
...
#final combined plot with common legend
grid.arrange(combined_plot, legend, nrow=2, heights=c(10,1), top = "Specificity plots for p = 0.5 setting")
```
...
#final combined plot with common legend
grid.arrange(combined_plot, legend, nrow=2, heights=c(10,1), top = "PPV plots for p = 0.5 setting")
```
...
#final combined plot with common legend
grid.arrange(combined_plot, legend, nrow=2, heights=c(10,1), top = "NPV plots for p = 0.5 setting")
```
...
#final combined plot with common legend
grid.arrange(combined_plot, legend, nrow=2, heights=c(10,1), top = "F-score plots for p = 0.5 setting")
```